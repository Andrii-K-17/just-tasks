...
<template>
  <div
    class="min-h-screen bg-emerald-50/30 text-black dark:bg-slate-950 dark:text-slate-100 transition-colors"
  >
    <div
      class="sticky h-13 top-0 z-50 shadow-xs w-full border-b border-emerald-100 bg-[#f9fefb] dark:bg-slate-950 dark:border-slate-800 transition-colors"
    >
        ...
        <div class="flex gap-3">
          ...
          <div class="relative" ref="settings">
            ...
            <Transition name="fade">
              ...
              >
                <p
                  class="px-4 py-2.5 text-sm text-gray-800 border-b border-emerald-400 font-medium dark:text-slate-200 dark:border-slate-700"
                >
                  {{ auth.user?.username }}
                </p>
                <button
    ...
    <div class="max-w-3xl mx-auto px-4 py-3">
      ...
      >
        ...
        <SearchBar />
        <p
          class="rounded-full text-xs py-1.5 px-3 border border-emerald-800 text-slate-900 dark:border-slate-600 dark:text-slate-300"
        >
